...
if( d2p_util.getCookie('NetiA') && typeof bm_list2300 == 'undefined' )
{
    document.write( '<script src="http://www.caribbeancom.com/d2p/bookmark_list2300.js"><\/script>' );
}
...
var d2p_bookmark = 
{
    ...
    get : function( _return, settings )
    {
        if( typeof settings != 'undefined' &&
            typeof settings.site_id != 'undefined' ) this.site_id = settings.site_id;

        var params =
        {
            url      : this.url_get + this.site_id,
            method   : 'get',
    ...
    get_callback : function( o, params )
    {
        if( o.readyState == 4 && o.status == 200 )
        {
            ...
            {
                if( typeof _bm_list[ list_s[i]['dl_movie_seq'] ] != 'undefined' )
                {
                    l = r.bm_lists.length;
...
{
    site_id : 20001117,
    url_get : '/snstb/api/bookmark?site_id=20001117',
    url_add : 'https://sns.d2pass.com/mylist/siteSide/create',
...
{
    site_id : 20001117,
    url_get : '/d2ptb/api/bookmark?site_id=20001117',
    ...
    write : function( params )
    {
        ...
        if( d2p_util.getCookie('d2p_free_member') == 1 )
        {
            alert( '本サイトをご購入いただくとレビューが投稿できます' );
            return;
        }
