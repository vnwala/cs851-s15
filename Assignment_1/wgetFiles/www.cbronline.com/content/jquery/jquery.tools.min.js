...
(function(b){var a=b.tools.tooltip;a.effects=a.effects||{};a.effects.slide={version:"1.0.0"};b.extend(a.conf,{direction:"down",bounce:true,slideOffset:-10,slideInSpeed:200,slideOutSpeed:200,slideFade:!b.browser.msie});var c={up:["-","top"],down:["+","top"],left:["-","left"],right:["+","left"]};b.tools.tooltip.addEffect("slide",function(d){var f=this.getConf(),g=this.getTip(),h=f.slideFade?{opacity:f.opacity}:{},e=c[f.direction]||c.up;h[e[1]]=e[0]+"="+f.slideOffset;if(f.slideFade){g.css({opacity:0})}g.show().animate(h,f.slideInSpeed,d)},function(e){var g=this.getConf(),i=g.slideOffset,h=g.slideFade?{opacity:0}:{},f=c[g.direction]||c.up;var d=""+f[0];if(g.bounce){d=d=="+"?"-":"+"}h[f[1]]=d+"="+i;this.getTip().animate(h,g.slideOutSpeed,function(){b(this).hide();e.call()})})})(jQuery);
...
$("#channel_1").tooltip({ effect: 'slide', position: 'bottom right', offset: [10, -61] });
$("#channel_2").tooltip({ effect: 'slide', position: 'bottom right', offset: [10, -122] });
$("#channel_3").tooltip({ effect: 'slide', position: 'bottom right', offset: [10, -103] });
$("#channel_4").tooltip({ effect: 'slide', position: 'bottom right', offset: [10, -58] });
$("#channel_5").tooltip({ effect: 'slide', position: 'bottom right', offset: [10, -98] });
$("#channel_6").tooltip({ effect: 'slide', position: 'bottom right', offset: [10, -48] });
    $("a.key").hover(function() {
