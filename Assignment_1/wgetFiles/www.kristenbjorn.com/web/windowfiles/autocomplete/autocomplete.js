var acListTotal=0;var acListCurrent=-1;var acDelay=500;var acURL=null;var acSearchId=null;var acResultsId=null;var acSearchField=null;var acResultsDiv=null;function setAutoComplete(field_id,results_id,get_url)
{acSearchId="#"+field_id;acResultsId="#"+results_id;acURL=get_url;$("#auto").append('<div style="z-index:110" id="'+results_id+'"></div>');acSearchField=$(acSearchId);acResultsDiv=$(acResultsId);repositionResultsDiv();acSearchField.blur(function(){setTimeout("clearAutoComplete()",200)});acSearchField.keyup(function(e){var keyCode=e.keyCode||window.event.keyCode;var lastVal=acSearchField.val();if(updownArrow(keyCode)){return;}
...
divs.click(function(){acSearchField.val(this.childNodes[0].nodeValue);clearAutoComplete();document.form1.submit();});}else{clearAutoComplete();}});}
function clearAutoComplete()
{acResultsDiv.html('');acResultsDiv.css("display","none");}
function repositionResultsDiv()
{var sf_pos=acSearchField.offset();var sf_top=sf_pos.top;var sf_left=sf_pos.left;var sf_height=acSearchField.height();var sf_width=acSearchField.width();acResultsDiv.css("position","absolute");
