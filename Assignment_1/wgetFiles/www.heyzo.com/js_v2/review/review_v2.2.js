...

{
...

   {
       ...
       makeRequest( "/app_v2/review_getjs/?id="+movie_seq+"&page="+page+"&r="+Math.random()+lang, reviews_set ); 
...

   {
       ...
       makeRequest( "/app_v2/review_getjs/?id="+movie_seq+"&showall=1&r="+Math.random()+lang, reviews_set );
