...
/*
     FILE ARCHIVED ON 11:53:04 Jun 6, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 6:18:57 Feb 10, 2015.
...
(function(jwplayer) {
	 ...
	 * !+"\v1" technique from /web/20130606115304/http://webreflection.blogspot.com/2009/01/32-bytes-to-know-if-your-browser-is-ie.html
	 ...
	 * getPathType('hd-1.4')
	 * 
	 * getPathType('/web/20130606115304/http://plugins.longtailvideo.com/5/hd/hd.swf')
	 * getPathType('/web/20130606115304/http://plugins.longtailvideo.com/5/hd/hd-1.swf')
	 * getPathType('/web/20130606115304/http://plugins.longtailvideo.com/5/hd/hd-1.4.swf')
	 * 
	 * getPathType('./hd.swf')
...
(function(jwplayer) {
	...
	jwplayer.plugins.plugin = function(url) {
		var _repo = "/web/20130606115304/http://plugins.longtailvideo.com"
		var _status = jwplayer.utils.loaderstatus.NEW;
		var _flashPath;
		var _js;
...
(function(jwplayer) {
	...
	jwplayer.embed.logo = function(logoConfig, mode, id) {
		var _defaults = {
			prefix: '/web/20130606115304/http://l.longtailvideo.com/'+mode+'/',
			file: "logo.png",
			link: "/web/20130606115304/http://www.longtailvideo.com/players/jw-flv-player/",
			margin: 8,
			out: 0.5,
			over: 1,
			timeout: 3,
...
(function(jwplayer) {
	jwplayer.html5.defaultSkin = function() {
		...
		///web/20130606115304/http://www.w3schools.com/Dom/dom_parser.asp 
		if (window.DOMParser) {
...
(function(jwplayer) {
	...
	var _defaults = {
		prefix: "/web/20130606115304/http://l.longtailvideo.com/html5/",
		file: "logo.png",
		link: "/web/20130606115304/http://www.longtailvideo.com/players/jw-flv-player/",
		margin: 8,
		out: 0.5,
...
(function(jwplayer) {
	...
	jwplayer.html5.mediavideo = function(model, container) {
		...
		function _embedYouTube(path) {
			...
			path = ["/web/20130606115304/http://www.youtube.com/v/", path.replace(/^[^v]+v.(.{11}).*/, "$1"), "&amp;hl=en_US&amp;fs=1&autoplay=1"].join("");
			var objectParams = {
				movie: path,
