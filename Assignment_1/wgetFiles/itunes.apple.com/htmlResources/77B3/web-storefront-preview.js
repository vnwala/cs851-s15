...
e.each(function(){jQuery(this).toggle()}),t.each(function(){jQuery(this).removeClass("active")}),jQuery(this).addClass("active")}})});
var r=["490217893"];
...
var itms=function(){return{replaceClass:function(e,t,n){return n||(n=""),dbg("Replacing "+t+" with "+n),e.className=e.className.replace(t,n),!1},PageData:{itunesDetectedCallback:function(e,t,n){e?(t?(document.getElementsByTagName("body")[0].className+=" launching-itunes",n?$("#loadingItunes").hide():$("#loadingIbooks").hide()):document.getElementsByTagName("body")[0].className+=" no-action",setTimeout(function(){var e=document.getElementsByTagName("body")[0].className;
