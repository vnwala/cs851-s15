...
(function($) {
	...
	// configurable values
	ARCS.base_uri = 'http://www'+ARCS.env+'.masslive.com/';
	ARCS.hash = [
		{"id":"massachusetts", "display":"Massachusetts", "nameplate": "Massachusetts", "path":"/", "zip_code":"01103",
			"blogs": {
				"default": ARCS.base_uri + "mass_impact_massachusetts-river/",
				"news": ARCS.base_uri + "mass_impact_news/",
				"sports": ARCS.base_uri + "mass_impact_sports/",
				"hssports": "http://highschoolsports.masslive.com/content/toprail_dropdown/region/statewide/",
				"entertainment": ARCS.base_uri + "mass_impact_entertainment/",
				"business": ARCS.base_uri + "mass_impact_business-news/",
				"living": ARCS.base_uri + "mass_impact_living/",
				"police_fire": ARCS.base_uri + "mass_impact_police-fire/",
				"politics": ARCS.base_uri + "mass_impact_politics/",
				"opinion": ARCS.base_uri + "mass_impact_opinion/",
				"springfield": ARCS.base_uri + "mass_impact_springfield/",
				"holyoke": ARCS.base_uri + "mass_impact_holyoke/",
				"worcester": ARCS.base_uri + "mass_impact_news/worcester/",
				"boston": ARCS.base_uri + "mass_impact_news/boston/",
				"umass_amherst": ARCS.base_uri + "mass_impact_umass-amherst/",
				"sports": ARCS.base_uri + "mass_impact_sports/",
				"red_sox": ARCS.base_uri + "mass_impact_redsox/",
				"patriots": ARCS.base_uri + "mass_impact_patriots/",
				"entertainment": ARCS.base_uri + "mass_impact_entertainment/",
				"hs-sports": ARCS.base_uri + "mass_impact_high_school_sports/"
			}
		},
		{"id":"default", "display":"Massachusetts", "nameplate": "Massachusetts", "path":"/", "zip_code":"01103",
			"blogs": {
				"default": ARCS.base_uri + "mass_impact_massachusetts-river/",
				"news": ARCS.base_uri + "mass_impact_news/",
				"sports": ARCS.base_uri + "mass_impact_sports/",
	...
	ARCS.weather = {"app": "http://weather-report"+ARCS.env+".masslive.com/weather/hp/json/",
					    "forecast": "http://weather-report"+ARCS.env+".masslive.com/weather/jsonp/3day/zip=",
					    "links": ["http://www.masslive.com/weather/","http://www.masslive.com/weather/"]};
	ARCS.media_path = ARCS.base_uri + "static/mass/static/";
	ARCS.cookie_domain = ".masslive.com";	
	ARCS.config.livefyre = {'siteid':{'prod':'352334','uat':'352507','dev':'304500'}};
	ARCS.is_regionalized = false;
	ARCS.custom_vars['QuerylyKey'] = "2d8c6eed2d2449e1";
	ARCS.custom_vars['css'] = {'mrf-port':'790','mrf-land':'790'};
