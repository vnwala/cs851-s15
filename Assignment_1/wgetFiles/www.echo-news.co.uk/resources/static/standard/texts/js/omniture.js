...
/************** Config Section ****************/
s.dstStart="03/31/2013";
s.dstEnd="10/27/2013";

var gfy = new Date();

s.currentYear= gfy.getFullYear();
/**********************************************/
...
if(!s.prop11&&!s.eVar11) s.prop11=s.eVar11=s.getTimeParting('h','0'); // Set hour
if(!s.prop12&&!s.eVar12) s.prop12=s.eVar12=s.getTimeParting('d','0'); // Set day
if(!s.prop13&&!s.eVar13) s.prop13=s.eVar13=s.getTimeParting('w','0'); // Set weekday

/*New vs Returning*/
s.prop10=s.getNewRepeat();
if (s.prop10) s.eVar10=s.prop10;

s.prop24= s.getNewRepeat(9125,'s_getNewRepeat');
if (s.prop10== "Repeat" && s.prop24 == "New") s.prop24="Repeat";

/*Visit No*/
if(!s.prop23&&!s.eVar23)
    s.prop23=s.getVisitNum();
...
if(s.prop2&&!s.eVar50) s.eVar50=s.prop2;
s.eVar74="newsquestgroupprod";
...
s.trackingServer="newsquestdigitalmedia.122.2o7.net"
